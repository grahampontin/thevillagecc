...
<P align=center>
<%
If Request.Form("action") <> "reset_password" or request("email") <> request("confirm_email") Then
	%>
...
Else
	...
	strSQL = "update users set password = '"&password&"' where user_name = '"&request("username")&"' and email_address = '"&request("email")&"'"
