...
<tr><td><%=RSplayer_id("player_name")%></td><td>&nbsp&nbsp&nbsp<input type=checkbox name=<%=RSplayer_id("player_id")%> value=yes></td></tr>
<%		
		end if
...
<input type=submit value='Confim Attendance' name=go>
</form>
