...
<body>
    <div id="pageContainer">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" src="match_reports/images/no_match_report_image.jpg" alt="Generic placeholder image" runat="server" id="mathcReportOne_Image">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5 col-md-pull-7">
          <img class="featurette-image img-responsive center-block" src="match_reports/images/no_match_report_image.jpg" alt="Generic placeholder image" runat="server" id="mathcReportTwo_Image">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" src="match_reports/images/no_match_report_image.jpg" alt="Generic placeholder image" runat="server" id="mathcReportThree_Image">
        </div>
      </div>
