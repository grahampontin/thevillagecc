...
export interface components {
  schemas: {
    ...
    Partnership: {
      ...
      balls?: (readonly components["schemas"]["Ball"][]) | null;
      /** Format: int32 */
      ballCount?: number;
      /** Format: int32 */
      score?: number;
    ...
    Player: {
      ...
      bio?: string | null;
      /** Format: int32 */
      numberOfMatchesPlayedThisSeason?: number;
      battingStatsData?: (readonly components["schemas"]["BattingCardLineData"][]) | null;
      bowlingStatsData?: (readonly components["schemas"]["BowlingStatsEntryData"][]) | null;
      fieldingStatsData?: (readonly components["schemas"]["BattingCardLineData"][]) | null;
    };
    PlayerDetailV1: {
