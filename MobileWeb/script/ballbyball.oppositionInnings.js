...
function initialiseOppositionInnings() {
    ...
    $("#submitButton").click(function() {
        ...
        var endOfInnings = $("#endOfInnings").prop("checked");
        ...
        if (wickets >= 10 && !endOfInnings) {
            showError("Ten wickets down probably means it's the end of the innnings don't you think?");
            return;
        }
